...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    permissions: [PERMISSIONS.APPOINTMENTS_READ_ANY, PERMISSIONS.BARBERS_READ],
  },
  {
    href: "/admin/reservas",
    label: "Reservas",
  ...
  },
  {
    ...
    permissions: [PERMISSIONS.FINANCE_MANAGE, PERMISSIONS.REPORTS_READ],
  },
  {
...
export function getVisibleNavItems(user: User | null | undefined) {
