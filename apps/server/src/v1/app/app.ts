...
import expenseRouter from "@/v1/routes/expenses/route";
...
import purchaseRouter from "@/v1/routes/purchases/route";
import reportRouter from "@/v1/routes/reports/route";
import serviceRouter from "@/v1/routes/services/route";
import supplyRouter from "@/v1/routes/supplies/route";
